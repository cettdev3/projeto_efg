...
urlpatterns = [
    ...
    path('ajax/ajax_load_tbleixos', load_funcoes_gerencia_eixo, name='ajax_load_funcoes_gerencia_eixo'),
    path('ajax/ajax_load_tblcursos', load_funcoes_gerencia_cursos, name='ajax_load_funcoes_gerencia_cursos'),
    ...
    path('ajax/ajax_load_total_horas', load_funcoes_total_horas, name='ajax_load_total_horas'),
    path('ajax/load-funcoes-filter', load_funcoes_filter, name='ajax_load_funcoes_filter'),
    ...
    path('ajax/load-funcoes-orcamento', load_funcoes_rubrica, name='ajax_load_funcoes_orcamento'),
