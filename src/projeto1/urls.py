...
from appprojeto1.views import (
    Logout_Users,
    load_ch,
    buscar_saldo_replanejado,
    verifica_turmas_edital,
    load_municipios,
    cadastrar_udepi,
    Autenticar,
    apaga_orcamento,
    ...
    load_cursos,
    load_eixos,
    load_funcoes_gerencia_cursos,
    load_funcoes_gerencia_eixo,
    load_funcoes_rp,
    load_funcoes_tabela,
    load_funcoes_total_horas,
    load_funcoes_vagas,
    apagar_meta,
    apagar_meta_sintetica,
    cad_metas,
    cad_metas_sintetica,
    cad_orcamento,
    cadastrar_meta_sintetica,
    load_funcoes_filter,
    cadastrar_metas,
    editar_meta,
    editar_metas_sintetica,
    editarmetas,
    load_funcoes_rubrica,
    load_modalidade,
    ...
    view_index,
    load_funcoes,
    ajax_load_turmas_edital,
    ajax_load_turmas_edital_filtro,
    atualiza_edital,
    gerenciar_usuarios,
    salvar_permissoes,
    enviar_planejamento,
    load_funcoes_permissoes,
    cadastrar_usuario,
    buscar_siga_selecao,
    replanejar_curso,
)
...
urlpatterns = [
    ...
    path("ajax/ajax_load_municipios", load_municipios, name="ajax_load_municipios"),
    path(
        "ajax/ajax_load_tbleixos",
        load_funcoes_gerencia_eixo,
        name="ajax_load_funcoes_gerencia_eixo",
    ),
    path(
        "ajax/ajax_load_tblcursos",
        load_funcoes_gerencia_cursos,
        name="ajax_load_funcoes_gerencia_cursos",
    ),
    path("ajax/ajax_load_modalidade", load_modalidade, name="ajax_load_modalidade"),
    path("ajax/ajax_load_recurso_planejado", load_funcoes_rp, name="ajax_load_horas"),
    path(
        "ajax/ajax_load_total_horas",
        load_funcoes_total_horas,
        name="ajax_load_total_horas",
    ),
    path(
        "ajax/load-funcoes-filter", load_funcoes_filter, name="ajax_load_funcoes_filter"
    ),
    path("ajax/ajax_load_tabela", load_funcoes_tabela, name="ajax_load_funcoes_tabela"),
    path(
        "ajax/ajax_load_carga_hr_disponivel",
        views.load_funcoes_chd,
    ...
    path(
        "orcamento-plano-trabalho",
        orcamento_plano_trabalho,
        name="orcamento-plano-trabalho",
    ),
    path(
        "ajax/load-funcoes-orcamento",
        load_funcoes_rubrica,
    ...
    path(
        "dash_aprovar/",
        views.DashboardAprovarCursosView.as_view(),
        name="DashboardAprovarCursosView",
    ),
    path(
        "aprova-cursos/<int:pk>/edit/",
        views.AprovarCursosUpdateView.as_view(),
        name="AprovarCursosUpdateView",
    ),
    path(
        "reprova-cursos/",
        views.ReprovaCursosUpdateView.as_view(),
        name="ReprovaCursosUpdateView",
    ),
    path(
        "verifica-turmas-edital", verifica_turmas_edital, name="verifica-turmas-edital"
    ),
