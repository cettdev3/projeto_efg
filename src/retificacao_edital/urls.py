...
from .views import (
    remover_turma_retificada,
    load_turmas_retificadas,
    retificar_edital,
    load_turmas_edital,
    load_turmas_edital_retificacao,
    load_edital_exist,
    retifica_turma_edital,
    redefinir_retificacao,
    verifica_saldo_disponivel,
    enviar_edital_aprovacao,
)
