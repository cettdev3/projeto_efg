from DivisaoDeMetas.forms import (
    DivisaoDeMetasForm,
    DivisaoDeMetasFilterFormHelper,
    DivisaoDeMetasFormDelete,
)
...
class DivisaoDeMetasView(
    LoginRequiredMixin, ExportMixin, FilteredSingleTableView, DivisaoDeMetasContextMixin
):
    login_url = "/"
...
class DivisaoDeMetasDetailView(
    LoginRequiredMixin, ModelFormMixin, DetailView, DivisaoDeMetasContextMixin
):
    login_url = "/"
...
class DivisaoDeMetasCreateView(
    LoginRequiredMixin, SuccessMessageMixin, CreateView, DivisaoDeMetasContextMixin
):
    login_url = "/"
    form_class = DivisaoDeMetasForm
    model = DivisaoDeMetasPorEscola
...
class DivisaoDeMetasUpdateView(
    LoginRequiredMixin, SuccessMessageMixin, UpdateView, DivisaoDeMetasContextMixin
):
    login_url = "/"
    form_class = DivisaoDeMetasForm
    model = DivisaoDeMetasPorEscola
...
class DivisaoDeMetasDeleteView(
    LoginRequiredMixin, ModelFormMixin, DeleteView, DivisaoDeMetasContextMixin
):
    login_url = "/"
