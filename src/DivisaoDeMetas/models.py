...
class DivisaoDeMetasPorEscola(DefaultTable):
    ...
    escola = models.ForeignKey(
        Metas_escolas, on_delete=models.DO_NOTHING, related_name='escolas', verbose_name='Nome da escola', help_text='Escola para execução da meta')
    ...
    tipo = models.ForeignKey(
        Metas_tipo, on_delete=models.DO_NOTHING, verbose_name='Tipo', help_text='Tipo do curso')
    modalidade = models.ForeignKey(
        Metas_modalidade, on_delete=models.DO_NOTHING, verbose_name='Modalidade', help_text='Modalidade de execução do curso')
