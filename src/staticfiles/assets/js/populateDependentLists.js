function populateDependentLists(source) {
    ...
    if (source.id === 'id_escola' || source.id === 'id_tipo_curso' || source.id === 'id_modalidade') {
        ...
        popularEixo(id_escola);
        console.log('Populando curso')
        popularCurso(id_escola, id_tipo_curso, id_modalidade, id_eixo);
    }
    ...
    function popularCurso(id_escola, id_tipo_curso, id_modalidade, id_eixo) {
        $.ajax({
            url: '/ajax/get_cursos/',
            type: 'GET',
            data: {
    ...
    function popularEixo(id_escola) {
        $.ajax({
            url: '/ajax/get_eixos/',
            type: 'GET',
            data: {
